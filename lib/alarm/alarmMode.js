...
function AlarmMode() {
    ...
    this.__defineGetter__('saftyAlarm', function () { return 'Safty Alarm'; });
    ...
    this.__defineGetter__('status', function () { return [this.saftyAlarm, this.securityAlarm, this.alarmClear]; });
};
