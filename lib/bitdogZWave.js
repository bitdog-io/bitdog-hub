...
function BitdogZWave() {
    ...
    zwave.on('node added', function (zwaveNodeid) {
        ...
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE,'Node added', zwaveNode);
    });
    ...
    function sendZwaveConfigurationMessage() {
        ...
        configurationMessage.d.nodes = zwaveNodes;
