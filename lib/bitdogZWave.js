...
function BitdogZWave(bitdogClient) {
    ...
    zwave.on('value added', function (zwaveNodeid, commandClassId, zwaveValue) {
    ...
    zwave.on('value changed', function (zwaveNodeid, commandClassId, zwaveValue) {
        var zwaveNode = zwaveNodes[zwaveNodeid];
    ...
    zwave.on('value removed', function (zwaveNodeid, commandClassId, instanceId, index) {
        var zwaveNode = zwaveNodes[zwaveNodeid];
            ...
            for (var comclass in zwaveNode.commandClasses) {
                switch (comclass) {
                    case 'SWITCH_BINARY': // COMMAND_CLASS_SWITCH_BINARY
                        zwave.enablePoll(zwaveNodeId, 37);
                        break;
                    case 'SWITCH_MULTILEVEL':// COMMAND_CLASS_SWITCH_MULTILEVEL
                        zwave.enablePoll(zwaveNodeId, 38);
                        break;
                }
            }
