...
function CoreMessageSchemas() {
    ...
    var _getVideoSourcesMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_GET_VIDEO_SOURCES);
    
    this.__defineGetter__('getVideoSourcesMessageSchema', function () {
        return _getVideoSourcesMessageSchema;
    });
