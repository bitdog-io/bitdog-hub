...
function CoreMessageSchemas() {
    ...
    var _zwaveAddSceneValue = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_ADD_SCENE_VALUE)
        .addStringProperty('homeId', '')
        .addNumberProperty('sceneId', 0)
        .addStringProperty('valueId', '')
        .addObjectProperty('value', null);

    var _zwaveRemoveSceneValue = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_REMOVE_SCENE_VALUE)
        .addStringProperty('homeId', '')
        .addNumberProperty('sceneId', 0)
        .addStringProperty('valudId', '');

    var _zwaveGetSceneValues = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_GET_SCENE_VALUES)
        .addStringProperty('homeId', '')
        .addNumberProperty('sceneId', 0);

    var _zwaveGetScenes = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_GET_SCENES)
        .addStringProperty('homeId', '');
    ...
    this.__defineGetter__('alarmDisarmMessageSchema', function () {
     ...
     this.__defineGetter__('zwaveAddSceneValue', function () {
         return _zwaveAddSceneValue;
    });

     this.__defineGetter__('zwaveRemoveSceneValue', function () {
         return _zwaveRemoveSceneValue;
    });

     this.__defineGetter__('zwaveGetSceneValues', function () {
         return _zwaveGetSceneValues;
    });

     this.__defineGetter__('zwaveGetScenes', function () {
         return _zwaveGetScenes;
    });
