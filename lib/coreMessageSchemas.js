...
function CoreMessageSchemas() {
    ...
    var _alarmStatusChangedMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ALARM_STATUS_CHANGED)
        .addStringProperty('status', alarmMode.disarmed, { values: alarmMode.modes });
    ...
    var _userNotificationEventMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_USER_NOTIFICATION)
    ...
    this.__defineGetter__('userNotificationEventMessageSchema', function () {
        return _userNotificationEventMessageSchema;
    });
