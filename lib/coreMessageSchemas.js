...
function CoreMessageSchemas() {
    ...
    var _videoMotionEventStartMessageSchema = bitdogClient.createMessageSchema(constants.SCHEMA_MOTION_EVENT_START)
        .addStringProperty('videoSource', '', {}, '', 'Video Source Path', '');

    var _videoMotionEventEndMessageSchema = bitdogClient.createMessageSchema(constants.SCHEMA_MOTION_EVENT_END)
        .addStringProperty('videoSource', '', {}, '', 'Video Source Path', '');
