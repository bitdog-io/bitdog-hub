...
function CoreMessageSchemas() {
    ...
    var _zwaveSceneConfigurationMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_SCENE_CONFIGURATION)
        .addStringProperty('homeId', '')
        .addNumberProperty('transactionId', 0)
        .addNumberProperty('sceneId', 0)
        .addObjectProperty('scene', null);
    ...
    this.__defineGetter__('zwaveSceneConfigurationMessageSchema', function () {
        return _zwaveSceneConfigurationMessageSchema;
    });
