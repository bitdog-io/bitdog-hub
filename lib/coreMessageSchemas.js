...
function CoreMessageSchemas() {
    ...
    var _zwaveNodeFoundMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_ZWAVE_NODE_FOUND)
        .addStringProperty('homeId', '')
    ...
    this.__defineGetter__('zwaveNodeFoundMessageSchema', function () {
        return _zwaveNodeFoundMessageSchema;
    });
