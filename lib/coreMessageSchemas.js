...
function CoreMessageSchemas() {
    ...
    var _weatherForecastMessageSchema = bitdogClient.createMessageSchema(constants.MESSAGE_SCHEMA_WEATHER_FORECAST)
        .addNumberProperty('currentTemperatureF', 0, {}, '', 'Current Temperature F','F')
        .addNumberProperty('currentTemperatureC', 0, {}, '', 'Current Temperature C', 'C')
        .addNumberProperty('currentPressureIn', 0, {}, '', 'Current Pressure Inches', '#Hg')
        .addNumberProperty('currentPressureMb', 0, {}, '', 'Current Pressure Millibars', 'mb')
        .addStringProperty('currentWindDirection', 0, {}, '', 'Current Wind Direction', '')
        .addNumberProperty('currentWindDegree', 0, {}, '', 'Current Wind Degree', '')
        .addNumberProperty('currentWindKph', 0, {}, '', 'Current Wind Kph', 'KPH')
        .addNumberProperty('currentWindMph', 0, {}, '', 'Current Wind Mph', 'MPH')
        .addNumberProperty('todayMinTemperatureF', 0, {}, '', 'Todays Minimum Temperature F','F')
        .addNumberProperty('todayMinTemperatureC', 0, {}, '', 'Todays Minimum Temperature C','C')
        .addNumberProperty('todayMaxTemperatureF', 0, {}, '', 'Todays Maximum Temperature F','F')
        .addNumberProperty('todayMaxTemperatureC', 0, {}, '', 'Todays Maximum Temperature C','C')
        .addNumberProperty('todayAvgTemperatureF', 0, {}, '', 'Todays Average Temperature F','F')
        .addNumberProperty('todayAvgTemperatureC', 0, {}, '', 'Todays Average Temperature C','C')
        .addNumberProperty('todayTotalPrecipitationIn', 0, {}, '', 'Todays Total Precipitation Inches')
        .addNumberProperty('todayTotalPrecipitationMm', 0, {}, '', 'Todays Total Precipitation Millimeters');
