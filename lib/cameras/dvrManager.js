...
function DVRManager() {
    ...
    this.__defineGetter__('url', function () { return _videoHubUrl; });
    this.__defineSetter__('url', function (value) { _videoHubUrl = value; });
}

DVRManager.prototype.start = function (videoHubUrl) {
...
DVRManager.prototype.uploadFile = function (fileName) {
    ...
    var promise = new Promise(function (resolve, reject) {
        try {
            ...
            request.post({ url: 'https://bitdog.io/home/test2',  formData:  formData }, function  (error, httpResponse, body)  {
