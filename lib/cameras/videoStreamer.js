...
VideoStreamer.prototype.startEncoder = function (url) {
    ...
    this.ffmpegProcess = childProcess.spawn('ffmpeg' , ['-s', '640x480', '-f', 'video4linux2', '-i', '/dev/' + self.source, '-f', 'mpeg1video', '-b:v', '800k', '-r', '30', url, '-f','h264','segment','-segment_time','60','-strftime','1', '%Y-%m-%d_%H-%M-%S.mp4']);
