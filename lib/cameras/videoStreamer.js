...
function VideoStreamer(source) {
    ...
    websocketChild.send({ name: 'start', source: source, url: 'wss://hub.bitdog.io/api/video/source/' + source, nodeId: bitdogClient.configuration.nodeId, authKey: bitdogClient.configuration.authKey });
