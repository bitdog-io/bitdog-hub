...
VideoStreamer.prototype.start = function () {
    ...
    this.websocketProcess.send({ name: 'start', source: this.source, url: this.url + '/source/' + encodeURI(this.source.replace(/\//gi,'\\')), nodeId: bitdogClient.configuration.nodeId, authKey: bitdogClient.configuration.authKey });
