...
function VideoStreamer(source) {
    ...
    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_VIDEO_STREAMER, 'Starting websocket streamer to Bitdog Cloud');
    var websocketChild = childProcess.fork(websocketsProcessPath, [], { execArgv: [], cwd: process.cwd(), silent: false });
...
module.exports.VideoStreamer = VideoStreamer;