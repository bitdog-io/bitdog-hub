        ...
        if (typeof message != typeof undefined && typeof message.name != typeof undefined && message.name != null) {
            ...
            switch (message.name) {
                ...
                case 'ws-connection-data':
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_VIDEO_STREAMER, 'Cloud websocket connection data message', message.data);
                    break;
                case 'ws-connection-sending-video':
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_VIDEO_STREAMER, 'Cloud websocket sending video', message.data);
                    break;
