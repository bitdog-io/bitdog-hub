...
function VideoStreamer(videoHubUrl, sourceId) {
...
VideoStreamer.prototype.start = function () {
    ...
    this.websocketProcess.send({ name: 'start', source: this.source, url: this.url + '/source/' + this.source, nodeId: bitdogClient.configuration.nodeId, authKey: bitdogClient.configuration.authKey });
