...
function Constants() {
    ...
    this.MESSAGE_SCHEMA_ZWAVE_ENABLE_POLLING = 'bitdog-zwave-enable-polling';
    this.MESSAGE_SCHEMA_ZWAVE_DISABLE_POLLING = 'bitdog-zwave-disable-polling';
    this.MESSAGE_SCHEMA_ZWAVE_GET_POLLING_INTENSITY = 'bitdog-zwave-get-polling-intensity';
    this.MESSAGE_SCHEMA_ZWAVE_GET_POLLING_ENABLED = 'bitdog-zwave-get-polling-enabled';
    ...
    this.MESSAGE_SCHEMA_AUTOMATION_SCHEDULED = 'bitdog-automation-scheduled';
    ...
    this.MESSAGE_SCHEMA_MOTION_EVENT_START = 'bitdog-motion-event-start';
    this.MESSAGE_SCHEMA_MOTION_EVENT_END = 'bitdog-motion-event-end';
    this.MESSAGE_SCHEMA_MOTION_IMAGE_CAPTURED = 'bitdog-motion-image-captured';
    ...
    this.ZWAVE_POLL_INTERVAL_CONFIG = 'zwave:pollInterval';
    this.ZWAVE_INTERVAL_BETWEEN_POLLS_CONFIG = 'zwave:intervalBetweenPolls';

    this.ALARM_NODE = 'alarm:mode';
    this.VIDEO_SOURCES = 'video:sources';
    this.VIDEO_ENABLED = 'video:enabled';
    this.VIDEO_STREAMER_PORT = "video:streamerPort";
    this.VIDEO_DVR_PATH = "video:dvrPath";
    this.IPC_PORT = "ipc:port";
    ...
    this.LOG_PROCESS_DVR_MANAGER = 'DVR Manager';
    this.LOG_PROCESS_IPC_MANAGER = 'IPC Manager';
