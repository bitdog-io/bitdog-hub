...
function bitdogHub() {
    ...
    bitdogClient.addCommand('bd-zHealNetworkNode', coreMessageSchemas.zwaveSetNodeMessageSchema, function (message, configuration, logger) {
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Heal network node command received', { homeId: message.homeId, nodeId: message.nodeId });
        bitdogZWave.healNetworkNode(message.nodeId);
    }, undefined, undefined, true);
    ...
    bitdogClient.addCommand('bd-zHealNetwork', coreMessageSchemas.zwaveControllerCommandMessageSchema, function (message, configuration, logger) {
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Heal netowrk command received', { homeId: message.homeId });
    ...
    bitdogClient.addCommand('bd-zHealNetworkNode', coreMessageSchemas.zwaveHealNetworkNodeMessageSchema, function (message, configuration, logger) {
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Heal network command received', { homeId: message.homeId, nodeId: message.nodeId, doReturnRoutes: message.doReturnRoutes });
