...
function BitdogHub() {
    ...
    bitdogClient.addCommand('bd-alarmArmAway', coreMessageSchemas.alarmArmAwayMessageSchema, function (message, configuration, logger, context, header) {
        ...
        bitdogAlarm.armAway({ c: context, d: message, h: header });
         systemEvents.publishSecurityArmAway();
   }, undefined, undefined, false,'Alarm Arm Away');
    
    bitdogClient.addCommand('bd-alarmArmStay', coreMessageSchemas.alarmArmStayMessageSchema, function (message, configuration, logger, context, header) {
        ...
        systemEvents.publishSecurityArmStay();
    }, undefined, undefined, false,'Alarm Arm Stay');
    
    bitdogClient.addCommand('bd-alarmDisarm', coreMessageSchemas.alarmDisarmMessageSchema, function (message, configuration, logger, context, header) {
    ...
    }, undefined, undefined, false, 'Alarm Disarm');

    bitdogClient.addDataCollector('bd-alarmStatus', coreMessageSchemas.alarmStatusMessageSchema, 1000 * 60 * 10, function (message, configuration, logger) {
        message.alarmMode = bitdogAlarm.alarmMode;

    }, false,'Alarm Status');

    bitdogClient.addData('bd-alarmEvent', coreMessageSchemas.alarmEventMessageSchema, false, 'Alarm Event');
    ...
    // Weather Data
    bitdogClient.addData('bd-weatherForecast', coreMessageSchemas.weatherForecastMessageSchema, false, 'Weather Forcast');
    ...
    bitdogClient.addCommand('bd-videoSourceStartStream', coreMessageSchemas.videoSourceStartStreamMessageSchema, function (message, configuration, logger) {
 

    }, undefined, undefined, true);
    
    bitdogClient.addCommand('bd-videoSourceStopStream', coreMessageSchemas.videoSourceStopStreamMessageSchema, function (message, configuration, logger) {
 

    }, undefined, undefined, true);

    bitdogClient.addData('bd-videoMotionEventStart', coreMessageSchemas.videoMotionEventStartMessageSchema, true);

    bitdogClient.addData('bd-videoMotionEventEnd', coreMessageSchemas.videoMotionEventEndMessageSchema, true);

    bitdogClient.addData('bd-videoMotionImageCaptured', coreMessageSchemas.videoMotionImageCapturedMessageSchema, true);
