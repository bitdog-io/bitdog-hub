...
function BitdogHub() {
    ...
    if (enableZWave === true) {
        ...
        bitdogClient.addCommand('bd-zGetSceneValues', coreMessageSchemas.zwaveGetScenesMessageSchema, function (message, configuration, logger) {
        ...
        bitdogClient.addCommand('bd-zCreateScene', coreMessageSchemas.zwaveCreateSceneMessageSchema, function (message, configuration, logger) {
            ...
            return { value: bitdogZWave.createScene(message.label) };
        }, undefined, undefined, true);
