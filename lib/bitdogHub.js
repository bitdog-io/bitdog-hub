...
function bitdogHub() {
    ...
    bitdogClient.addDataCollector('bd-zNodeFound', coreMessageSchemas.zwaveNodeFoundMessageSchema, -1, function (message, configuration, logger) {
    }, true);

    bitdogClient.addDataCollector('bd-zControllerMode', coreMessageSchemas.zwaveControllerModeMessageSchema, -1, function (message, configuration, logger) {
    }, true);
