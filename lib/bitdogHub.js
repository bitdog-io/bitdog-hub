...
function BitdogHub() {
    ...
    bitdogClient.addData('bd-videoMotionEventStart', coreMessageSchemas.videoMotionEventStartMessageSchema, false);

    bitdogClient.addData('bd-videoMotionEventEnd', coreMessageSchemas.videoMotionEventEndMessageSchema, false);

    bitdogClient.addData('bd-videoMotionImageCaptured', coreMessageSchemas.videoMotionImageCapturedMessageSchema, false);
