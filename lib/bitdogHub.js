...
function BitdogHub() {
    ...
    // Alarm commands
    bitdogClient.addCommand('bd-alarmArmAway', coreMessageSchemas.alarmArmAwayMessageSchema, function (message, configuration, logger) {
    ...
    bitdogClient.addCommand('bd-alarmArmStay', coreMessageSchemas.alarmArmStayMessageSchema, function (message, configuration, logger) {
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ALARM, 'Arm stay received', message);
        bitdogAlarm.armStay(message);
    }, undefined, undefined, false);
    
    bitdogClient.addCommand('bd-alarmDisarm', coreMessageSchemas.alarmDisarmMessageSchema, function (message, configuration, logger) {
