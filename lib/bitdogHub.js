...
function BitdogHub() {
    ...
    if (enableZWave === true) {
        ...
        bitdogClient.addDataCollector('bd-zSceneEvent', coreMessageSchemas.zwaveSceneEventMessageSchema, -1, function (message, configuration, logger) {
        }, true);
    ...
    bitdogClient.addDataCollector('bd-alarmStatusChanged', coreMessageSchemas.alarmStatusChangedMessageSchema, -1, function (message, configuration, logger) {
    }, false);

    bitdogClient.addDataCollector('bd-alarmEvent', coreMessageSchemas.alarmEventMessageSchema, -1, function (message, configuration, logger) {
    }, false);

    bitdogClient.addDataCollector('bd-userNotificationEvent', coreMessageSchemas.userNotificationEventMessageSchema, -1, function (message, configuration, logger) {
    }, true);

    bitdogClient.addCommand('bd-sendUserNotification', coreMessageSchemas.userNotificationEventMessageSchema, function (message, configuration, logger, context, header) {
        logger.logProcessEvent(constants.LOG_PROCESS_ALARM, 'Send user notification', message);
        bitdogClient.sendData('bd-userNotificationEvent', coreMessageSchemas.userNotificationEventMessageSchema, function (newMessage) {
    ...
    bitdogClient.addCommand('bd-getZones', coreMessageSchemas.getZonesMessageSchema, function (message, configuration, logger) {
        bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Get zones received', message);
