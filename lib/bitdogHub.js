...
function BitdogHub() {
    ...
    bitdogClient.addData('bd-alarmStatusChanged', coreMessageSchemas.alarmStatusChangedMessageSchema, false);

    bitdogClient.addData('bd-alarmEvent', coreMessageSchemas.alarmEventMessageSchema, false);

    bitdogClient.addData('bd-userNotificationEvent', coreMessageSchemas.userNotificationEventMessageSchema, true);
