...
function initializeZWave() {
    ...
    zwave.on('value added', function (zwaveNodeid, comclass, value) {
        ...
        bitdog.logger.logProcessEvent('ZWave value added', { zwaveNodeId: zwaveNodeid, commandClass: comclass, instance: value.index, value: value });
    });
    ...
    zwave.on('value changed', function (zwaveNodeid, comclass, value) {
        if (zwaveNodes[zwaveNodeid]['ready']) {
            bitdog.logger.logProcessEvent('ZWave value changed', { zwaveNodeId: zwaveNodeid, commandClass: comclass, instance: value.index, oldValue: zwaveNodes[zwaveNodeid]['classes'][comclass][value.index]['value'], newValue: value });
        }
