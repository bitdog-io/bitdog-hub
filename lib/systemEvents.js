...
function SystemEvents(bitdogHub, configuration, logger) {
    ...
    this.publishSecurityArmAway = function () {
        ...
        eventInfo.text = 'Bitdog Hub security armed, set for away mode';
        publish(eventInfo);
    };
    ...
    this.publishSecurityArmStay = function () {
        ...
        eventInfo.text = 'Bitdog Hub security armed, set for stay mode';
        publish(eventInfo);
    };
    ...
    this.publishSecurityDisarmed = function () {
        ...
        eventInfo.text = 'Bitdog Hub security has been disarmed';
        publish(eventInfo);
    };
    ...
    this.publishZWaveAddNode = function (zwaveNode) {
        ...
        eventInfo.text = 'Added ' + zwaveNode.displayName;
