        ...
        self.zwaveValuesDb.findOne({ id: key }, {}, function (err, record) {
            if (err != null) {
                ...
                if (record != null && typeof record != typeof undefined) {
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_BRAIN, 'Updating data in zwaveValuesDb', record);
                    ...
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_BRAIN, 'Inseting data in zwaveValuesDb', record);
