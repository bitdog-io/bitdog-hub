        ...
        if (err != null) {
            ...
            if (record != null && typeof record != typeof undefined) {
                ...
                self.zwaveNodesDb.insert({ homeId: homeId, nodeId: node.id, node: node }, {}, function (err, result) {
                    bitdogClient.sendData('bd-zNodeFound', coreMessageSchemas.zwaveNodeFoundMessageSchema, function (message) {
...
Brain.prototype.getZWaveValue = function (homeId, nodeId, instanceId, index) {
    var self = this;
    return new Promise(function (resolve, reject) {
        var id = homeId + '-' + nodeId + '-' + instanceId + '-' + index;
...
Brain.prototype.setTemperature = function (homeId, nodeId, celsius) {
    var coolingSetpointValue = this.getZWaveValue(homeId, nodeId, 1, 2);
    var heatingSetpointValue = this.getZWaveValue(homeId, nodeId, 1, 1); 
