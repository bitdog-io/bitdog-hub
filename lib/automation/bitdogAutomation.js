...
function BitdogAutomation() {
    ...
    var _weatherTimer = setInterval(function () { this.weatherTock(); }.bind(this), 1000 * 60 * 60); // Get weather update tick-tock
    var _scheduler = null;
    var _eventCapturer = null;
    setTimeout(function () { this.weatherTock() }.bind(this), 1000 * 60 * 60); // Get weather update tick-tock
    ...
    setTimeout(function () { this.weatherTock(); }.bind(this), 1000); // Get weather update once 
}
