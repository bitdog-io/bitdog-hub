        ...
        if (this.compare(message, trigger) === true) {
            ...
            if (this.shouldIgnore(definition) === false) { // This step potentially requires heavier computation, so its checked second
                ...
                for (var commandIndex = 0; commandIndex < definition.commands.length; commandIndex++) {
                    ...
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_AUTOMATION, 'Executed automation: \'' + name + '\'', messageResult);
                }
            }
            else {
...
EventCapturer.prototype.shouldIgnore = function (definition) {
    ...
    if (triggerFilter.filterTypeId === 'always') {
        ...
        var startTime = this.getTargetTime(triggerFilter.start, location.latitude, location.longitude);
        var endTime = this.getTargetTime(triggerFilter.end, location.latitude, location.longitude);
...
EventCapturer.prototype.compare = function (message, trigger) {
    ...
    if (typeof trigger.classId != typeof undefined || typeof trigger.reference.zwaveNodeId !== typeof undefined) {
        for (var property in logic) {
            switch (logic[property]) {
                ...
                case '<=':
                    ...
                    break;
                case 'between':
                    results = results && (message.d.value > trigger.value && message.d.value < trigger.value2);
                    break;
                case 'starts with':
                    results = results && typeof message.d.value != typeof undefined && message.d.value != null && message.d.value.startsWith(trigger.value);
                    break;
                case 'ends with':
                    results = results && typeof message.d.value != typeof undefined && message.d.value != null && message.d.value.endsWith(trigger.value);
                    break;
                case 'contains':
                    results = results && typeof message.d.value != typeof undefined && message.d.value != null && message.d.value.indexOf(trigger.value) != -1;
                    break;
                case "equals":
                    results = results && (message.d.value == trigger.value);
                    break;
        ...
        for (var property in logic) {
            switch (logic[property]) {
                case 'ignore':
                    break;
                case '=':
                    results = results && (message.d[property] == trigger.value[property]);
                    break;
                case '!=':
                    results = results && (message.d[property] != trigger.value[property]);
                    break;
                ...
                case '<=':
                    ...
                    break;
                case 'between':
                    results = results && (message.d[property] > trigger.value[property] && message.d[property] < trigger.value2[property]);
                    break;
                case 'starts with':
                    results = results && typeof message.d[property] != typeof undefined && message.d[property] != null && message.d[property].startsWith(trigger.value[property]);
                    break;
                case 'ends with':
                    results = results && typeof message.d[property] != typeof undefined && message.d[property] != null && message.d[property].endsWith(trigger.value[property]);
                    break;
                case 'contains':
                    results = results && typeof message.d[property] != typeof undefined && message.d[property] != null && message.d[property].indexOf(trigger.value[property]) != -1;
                    break;
                case "equals":
                    results = results && (message.d[property] == trigger.value[property]);
                    break;
