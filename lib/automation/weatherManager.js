...
WeatherManager.prototype.processWeatherForecast = function (weatherForecast) {
    ...
    bitdogClient.sendData('bd-weatherForecast', coreMessageSchemas.weatherForecastMessageSchema, function (message) {
        ...
        message.todayAvgTemperatureC = weatherForecast.forecast.forecastday[0].day.avgtemp_c;
        message.todayAvgTemperatureF = weatherForecast.forecast.forecastday[0].day.avgtemp_f;
        message.todayMaxTemperatureC = weatherForecast.forecast.forecastday[0].day.maxtemp_c;
        message.todayMaxTemperatureF = weatherForecast.forecast.forecastday[0].day.maxtemp_f;
        message.todayMaxWindKph = weatherForecast.forecast.forecastday[0].day.maxwind_kph;
        message.todayMaxWindMph = weatherForecast.forecast.forecastday[0].day.maxwind_mph;
        message.todayMinTemperatureC = weatherForecast.forecast.forecastday[0].day.mintemp_c;
        message.todayMinTemperatureF = weatherForecast.forecast.forecastday[0].day.mintemp_f;
        message.todayTotalPrecipitationIn = weatherForecast.forecast.forecastday[0].day.totalprecip_in;
        message.todayTotalPrecipitationMm =  weatherForecast.forecast.forecastday[0].day.totalprecip_mm;
    });
}


var weatherManager = new WeatherManager();
module.exports = weatherManager; // singleton 