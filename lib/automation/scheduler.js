                ...
                switch (trigger.dateTimeId) {
                    ...
                    case 'everyDay':
                        ...
                        if (trigger.timeTypeId === 'specific') {
                            ...
                            var targetTime = astronomicalTimes[trigger.timeTypeId];
                            bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_AUTOMATION, 'Target time for automation \'' + name + '\'', targetTime);
