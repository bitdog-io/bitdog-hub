...
function ZWaveNode(zwaveNodeId, homeId) {
    ...
    this.updateValue = function (zwaveValue)
    {
        ...
        if (typeof oldValue === typeof undefined)
            bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Value added', { zwaveNodeId: zwaveNodeId, commandClass: commandClassName, value: zwaveValue });
        else
            bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Value updated', { zwaveNodeId: zwaveNodeId, commandClass: commandClassName, oldValue: oldValue, newValue: zwaveValue });
