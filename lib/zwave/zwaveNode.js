...
function ZWaveNode(zwaveNodeId, homeId) {
    ...
    this.removeValue = function (commandclass, instance, index) {
        var commandClass = this.commandClasses[commandclass];
        ...
        if (typeof commandClass != typeof undefined) {
            ...
            if (typeof instance != typeof undefined) {
                if (instance[zwaveValue.index])
                    delete instance[zwaveValue.index];
            }
        }
    }
}
