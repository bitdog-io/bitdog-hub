...
function ZWaveNode(nodeId, zwave) {
    ...
    this.setNodeInformation = function (zwaveNodeInfo, ready) {
        ...
        _typeGeneric = decimalToHex(zwave.getNodeGeneric(_id),4);
        _typeBasic = decimalToHex(zwave.getNodeSpecific(_id),4);
        _typeSpecific = decimalToHex(zwave.getNodeBasic(_id),4);
