...
function ZWaveNode(nodeId, homeId) {
    ...
    this.updateValue = function (zwaveValueInfo)
    {
        ...
        if (typeof zwaveValue === typeof undefined) {
            ...
            bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Value updated', { nodeId: nodeId, commandClass: commandClassName, valueId: zwaveValue.id, label: zwaveValue.label, oldValue: zwaveValue.value, newValue: zwaveValueInfo.value });
