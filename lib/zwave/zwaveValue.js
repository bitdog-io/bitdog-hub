...
function ZWaveValue(zwaveValueInfo) {
    ...
    var _min = zwaveValueInfo.min;
    var _max = zwaveValueInfo.max;
    ...
    this.updateValue = function (zwaveValueInfo) {
        ...
        if (_value !== convertedValue || _firstUpdate === true) {
            result = true;
            zwaveValueInfo.new = true;
        }
        else if (_updateDateTimeUTC.getTime() + 60000 < (new Date(moment.utc().format())).getTime()) {
            result = true;
            zwaveValueInfo.new = false;
        } else {
            zwaveValueInfo.new = false;
        }
