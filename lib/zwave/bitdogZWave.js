...
function BitdogZWave(bitdogClient) {
    ...
    var logFormatter = function (category, text, arg) {
        if (arg instanceof Object) {
            if (typeof arg.d !== typeof undefined && arg.d !== null && typeof arg.d.nodeId !== typeof undefined && arg.d.nodeId !== null) {
                var node = zwaveHome.getNode(arg.d.nodeId);

                if (node !== null) {
                    var logText = text + + os.EOL + 'Node: ' + node.displayName + os.EOL + JSON.stringify(arg, null, 2);
                    return logText;
                }
            }
        }
