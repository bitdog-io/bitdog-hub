...
function BitdogZWave(bitdogClient) {
    ...
    function sendZwaveConfigurationMessages() {
        ...
        var transactionId2 = transactionId + 1;
        ...
        for (var index = 0; index < zwaveHome.nodes.length; index++) {
            ...
            configurationMessage.d.transactionId = transactionId;
        ...
        saveZwaveConfigurations(transactionId2, zwaveHome.homeId, zwaveHome.nodes);
