...
function BitdogZWave(bitdogClient) {
    ...
    this.pressButton = function (nodeId, classId, instanceId, index) {
        zwave.pressButton({ nodeid: nodeId, class_id: classId, instance: instanceId, index: index });
    }
    
    this.releaseButton = function (nodeId, classId, instanceId, index) {
        zwave.releaseButton({ nodeid: nodeId, class_id: classId, instance: instanceId, index: index });
    }
