...
function BitdogZWave(bitdogClient) {
        ...
        if (arg instanceof Object) {
            if (typeof arg.d !== typeof undefined && arg.d !== null) {
                ...
                if (typeof arg.d.nodeId !== typeof undefined && arg.d.nodeId !== null) {
                    ...
                    if (zwaveNode !== null) {
                        var logText = text + os.EOL + JSON.stringify(arg, null, 2) + os.EOL + 'Node: ' + zwaveNode.displayName
                        return logText;
                    }
                    ...
                    if (zwaveNode != null) {
                        ...
                        if (zwaveClass != null) {
                            logText = logText + os.EOL + 'Class: ' + zwaveClass.name;

                            var zwaveValue = zwaveClass.getValue(valueId.instanceId, valueId.indexId);

                            if (zwaveValue != null) {
                                logText = logText + os.EOL + 'Value: ' + zwaveValue.label;
                            }
    ...
    function sendZwaveConfigurationMessages() {
        ...
        for (var index = 0; index < zwaveHome.nodes.length; index++) {
            ...
            bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Meighbors', neighbors);
